# 从网上baostock api直接获取DataFrame，并加载成PandasData
...
# rs.get_data()得到的DataFrame中所有的数字都是字符串形式的
print(type(dataframe['open'][0]))
print(dataframe['open'][0])
...
data = bt.feeds.PandasData(
    ...
    fromdate=datetime(2019, 1, 2),  # 起始日
